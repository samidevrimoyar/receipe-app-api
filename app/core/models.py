...
# ...
# boat adında bir uygulama yaratmak için konsol komutu koşuyoruz:
# C:\Users\samid\development\recipe-app-api>docker-compose run --rm app sh -c "python manage.py startapp boat"
####################################################################
